          ...
          <div className="mb-8 flex flex-wrap gap-3">
            {calendarSources.map((source) => (
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-primary/10 px-5 py-2.5 text-sm font-semibold text-zinc-700 transition-colors hover:bg-primary/5"
              >
