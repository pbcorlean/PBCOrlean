        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-3">
          <Card>
            ...
            <a
              ...
              className="mt-4 inline-flex w-full items-center justify-center rounded-full bg-secondary px-6 py-3 text-sm font-semibold text-primary-dark transition-colors hover:bg-secondary-dark"
            >
              Give Online
            </a>
          </Card>
